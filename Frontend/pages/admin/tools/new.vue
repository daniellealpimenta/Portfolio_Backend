<template>
  <div class="max-w-2xl">
    <div class="mb-6 flex items-center gap-4">
      ...
      <h1 class="text-h2 m-0 text-text">Novo(a) Ferramentas</h1>
    </div>
    ...
    <form @submit.prevent="handleSubmit" class="bg-surface border border-border rounded-2xl p-6 space-y-6">
      ...
      <div>
        <label class="block text-meta text-xs text-muted mb-2">URL do Ícone </label>
...
const { createTool } = usePortfolioApi()
